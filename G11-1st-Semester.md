...
- Block Diagram of CPU
  ...
  - ![截屏2025-11-21 10.33.10](typora-user-images/截屏2025-11-21_10.33.10.png)
...
- **Composite key and Concatenated key**(used when single attribute cannot uniquely idendify each row)
  ...
  - **The difference between these two keys:** 
    ...
    - ![截屏2025-11-04 10.59.46](typora-user-images/截屏2025-11-04_10.59.46.png)
...
- ***Database schema***:  is a blueprint of the database that identifies the different entities (tables), attributes (fields) and relationships (links) within the database, including the restraints on the data. 
  ...
  - ![截屏2025-10-25 15.08.16](typora-user-images/截屏2025-10-25_15.08.16.png)
...
- ***Logical Schema***: This model of the database identifies the different attributes within each of the entities. This will include the primary keys and foreign keys which create the relationships between the entities. Primary key is bold, foreign key is represented by "*". 
  - ![截屏2025-10-25 15.10.05](typora-user-images/截屏2025-10-25_15.10.05.png)
...
- ![截屏2025-10-25 15.11.44](typora-user-images/截屏2025-10-25_15.11.44.png)
...
- ***Chen Notation Sytle*** 
  - <img src="typora-user-images/截屏2025-10-25_15.13.46.png" alt="截屏2025-10-25 15.13.46" style="zoom:80%;" />
...
- String data types: 
  - ![截屏2025-10-25 15.20.12](typora-user-images/截屏2025-10-25_15.20.12.png)
...
- Numeric data types:
  - <img src="typora-user-images/截屏2025-10-25_15.20.28.png" alt="截屏2025-10-25 15.20.28" style="zoom:150%;" />
...
- Date/time data types: 
  - ![截屏2025-10-25 15.38.09](typora-user-images/截屏2025-10-25_15.38.09.png)

## A3.2.4 Construct tables for relational databases

- ![截屏2025-10-25 16.09.41](typora-user-images/截屏2025-10-25_16.09.41.png)
...
- **The process of normalization**
  ...
  - ![截屏2025-10-28 16.27.59](typora-user-images/截屏2025-10-28_16.27.59.png)
  - ![截屏2025-10-28 16.28.08](typora-user-images/截屏2025-10-28_16.28.08.png)
  - ![截屏2025-10-28 16.28.16](typora-user-images/截屏2025-10-28_16.28.16.png)
...
- **How to construct from UNF to 1NF to 2NF to 3NF:**
  ...
  - - Split, to get 1NF
    ...
    - ![截屏2025-10-28 20.30.24](typora-user-images/截屏2025-10-28_20.30.24.png)

    - ![截屏2025-10-28 20.30.33](typora-user-images/截屏2025-10-28_20.30.33.png)

    - ![截屏2025-10-28 20.30.38](typora-user-images/截屏2025-10-28_20.30.38.png)
...
- ![截屏2025-10-25 16.14.22](typora-user-images/截屏2025-10-25_16.14.22.png)
...
- ***Data manipulation language(DML)***
  ...
  - ![截屏2025-10-25 16.20.39](typora-user-images/截屏2025-10-25_16.20.39.png)
...
- **Transaction control language(TCL)**
  ...
  - ![截屏2025-10-25 16.30.00](typora-user-images/截屏2025-10-25_16.30.00.png)
...
- Data types in python
  - ![截屏2025-10-25 18.18.58](typora-user-images/截屏2025-10-25_18.18.58.png)
...
- ![截屏2025-10-25 18.24.59](typora-user-images/截屏2025-10-25_18.24.59.png)
...
- **Common Python Exceptions**
  - ![截屏2025-10-25 18.37.21](typora-user-images/截屏2025-10-25_18.37.21.png)
...
- Common Stack Methods:
  - ![截屏2025-10-25 19.51.02](typora-user-images/截屏2025-10-25_19.51.02.png)
- This will help you understand it more clearly:
  - ![截屏2025-10-25 19.51.32](typora-user-images/截屏2025-10-25_19.51.32.png)
- Overflow and underflow:
  - ![截屏2025-10-25 19.53.00](typora-user-images/截屏2025-10-25_19.53.00.png)
- Applications of stack in computing:
  - Function call management (Call Stack) : Stacks are essential in recursive algorithms. Every time a recursive call is made the current state is pushed onto the stack. Once the base case is resolved the pop method is used to resolve the calls.  
    - ![截屏2025-10-25 20.05.42](typora-user-images/截屏2025-10-25_20.05.42.png)
  ...
  - Parsing: A stack is used to ensure that all of the brackets are closed. For example, in Java if the bracket `{}` are closed, every time an open bracket `{ `is read it is pushed onto the stack and every time a closed bracket ``}`` is read it is popped from the stack.  An empty stack means the correct number of brackets. 
    - ![截屏2025-10-25 20.07.00](typora-user-images/截屏2025-10-25_20.07.00.png)
...
- When are stack and queue suitable
  - ![截屏2025-10-25 19.56.12](typora-user-images/截屏2025-10-25_19.56.12.png)
...
- A diagram to help understand FIFO:
  ...
  - ![截屏2025-10-25 20.10.56](typora-user-images/截屏2025-10-25_20.10.56.png)

    - **Here, notice that the left is the rear(队尾)，the right is the head(队头), you can also do it reversly.**

  - Common Methods for Queue:

    - ![截屏2025-10-25 20.12.05](typora-user-images/截屏2025-10-25_20.12.05.png)
  ...
  - When are stack and queue most suitable?
    ...
    - ![截屏2025-10-25 20.14.50](typora-user-images/截屏2025-10-25_20.14.50.png)
...
- ![截屏2025-10-25 20.15.51](typora-user-images/截屏2025-10-25_20.15.51.png)
...
- Big O notation: Time complextity:
  - ![截屏2025-10-25 20.20.35](typora-user-images/截屏2025-10-25_20.20.35.png)
...
- Explanation of the **time complexity of quick sort** under different situations: 
  ...
  - ![截屏2025-11-18 21.40.50](typora-user-images/截屏2025-11-18_21.40.50.png)
